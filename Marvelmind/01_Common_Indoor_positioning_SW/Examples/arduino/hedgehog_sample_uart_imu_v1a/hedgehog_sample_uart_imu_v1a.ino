      ...
      switch(hedgehog_serial_buf_ofs)
      {
        ...
        case 3:
        {
          ...
          good_byte=   (hedgehog_data_id == POSITION_DATAGRAM_ID) ||
                       ...
                       (hedgehog_data_id == NT_IMU_FUSION_DATAGRAM_ID);
          break;
        }
        case 4:
        {
        ...
        {// checksum success
          switch(hedgehog_data_id)
          {
            ...
            case NT_IMU_FUSION_DATAGRAM_ID:
            {
              ...
              if (hedgehog_data_id == IMU_FUSION_DATAGRAM_ID) {
                ...
                imu_fusion_timestamp= un32.vi32;
              } else {
                un64.b[0]= hedgehog_serial_buf[39];
                un64.b[1]= hedgehog_serial_buf[40];
                un64.b[2]= hedgehog_serial_buf[41];
                un64.b[3]= hedgehog_serial_buf[42];
                un64.b[4]= hedgehog_serial_buf[43];
                un64.b[5]= hedgehog_serial_buf[44];
                un64.b[6]= hedgehog_serial_buf[45];
                un64.b[7]= hedgehog_serial_buf[46];
                imu_fusion_timestamp= un64.vi64;
              }
...
//#define LCD_FUSION_V 3
//#define LCD_FUSION_A 4
  lcd_show_mode= LCD_FUSION_QUATERNION;
